...
export const emailConfirmationFooterText = () => {
  return `You are receiving this email because you have signed up for an account at www.iaad.management and/or confirmed to receive our newsletter. You can unsubscribe here </a>&nbsp;or&nbsp;<a target="_blank" style="line-height: 150%;" href="">Update your subscription preferences</a>.`;
}
...
<head>
    ...
    <title>${emailConfirmationSubject}</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p40b es-p40r es-p40l" esd-custom-block-id="8537" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" align="left" width="518" height="235px">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-c es-p15t" align="center" height="65px">
                                                                                        <p style="font-size: 0.9rem">${emailConfirmationText()}</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p15b es-p10r es-p10l" align="center"><span class="es-button-border" height="95px"><a href="${appConfig.web_url}onboarding/${user?.id}" class="es-button" target="_blank" style="font-family: helvetica,"helvetica neue",arial,verdana,sans-serif;background: #1e8ae6;border-color: #1e8ae6;padding: 20px;color: #fff;text-transform: capitalize;text-decoration: none;">Fill Out Information</a></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p10t es-p10b">
                                                                                        <p style="line-height: 150%;">You are receiving this email because you have visited our site or asked us about the regular newsletter. You can&nbsp;<a target="_blank" class="unsubscribe" style="line-height: 150%;">unsubscribe here</a>&nbsp;or&nbsp;<a target="_blank" style="line-height: 150%;" href="">update your subscription preferences</a>.</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
